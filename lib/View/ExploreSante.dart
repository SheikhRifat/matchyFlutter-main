...
class _SanteState extends State<Sante> {
  ...
  await FirebaseFirestore.instance.collection('Users').where("secteurActivite",isEqualTo: "Santé" )
  .get().then((val) {
    setState(() {  });
 ...
 GetUser()async{
  ...
  super.initState();
   GetUser();
    ...
    timer = new Timer.periodic(Duration(seconds: 2), (Timer t) =>   SanteExplore());
