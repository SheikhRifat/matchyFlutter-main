...
void MatchB2B() async {
  ...
  await FirebaseFirestore.instance.collection('Users').where("objectifs",arrayContainsAny: ["Développer mon buisness"] )
  .get().then((val) {
    setState(() {  });
...
print(e);
  ...
  void initState() {
     super.initState();
     GetUser();
    timer = new Timer.periodic(Duration(seconds: 2), (Timer t) =>   MatchB2B());
